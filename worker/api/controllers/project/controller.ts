...
export class ProjectController extends BaseController {
	...
	static async createOrGetUser(
		...
		try {
			...
			if (!bodyResult.success) {
				return bodyResult.response as ControllerResponse<ApiResponse<UserData>>;
			}
			...
			if (!user) {
				// Create new user - id will be auto-generated by the service
	...
	static async createProject(
		...
		try {
			...
			// Initialize agent asynchronously (fire and forget)
